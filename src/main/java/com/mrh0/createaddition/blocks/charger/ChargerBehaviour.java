...
public class ChargerBehaviour extends TileEntityBehaviour {

	public static BehaviourType<ChargerBehaviour> TYPE = new BehaviourType<>();

	TransportedItemStack heldItem;
	List<TransportedItemStack> incoming;
	ItemStackHandler processingOutputBuffer;
	ChargerItemHandler itemHandler;
	LazyOptional<ChargerItemHandler> lazyItemHandler;
	...
	public ChargerBehaviour(SmartTileEntity te) {
		super(te);
		maxStackSize = () -> 64;
		canAcceptItems = () -> true;
